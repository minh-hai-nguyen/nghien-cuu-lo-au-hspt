...
PB('Adolescent anxiety disorders are consistently more prevalent '
   ...
   'female-higher scores on SAD, raising a central research '
...
PB('Anxiety disorders are among the most common mental health '
   ...
   'reach peak vulnerability earlier than boys. Mô hình vững '
...
PB('Có ba cơ chế lý thuyết — đứng riêng lẻ hoặc kết hợp — có '
   ...
   'Co-rumination — cùng đào sâu lo lắng — chỉ xu hướng tình bạn '
...
PB('Hai kiểm định này chỉ rõ ở đường dẫn nào giới có vai trò, '
   'ở đường dẫn nào không có. Đây là thông tin có giá trị thực '
   'tế hơn hẳn so với chỉ báo cáo "nữ có điểm trung bình cao '
   'hơn". Chẳng hạn, nếu '
   ...
   'giới có vai trò và nơi không. Điều này có giá trị thực tế '
...
PB('Comparing the unconstrained vs constrained models, we '
   ...
   'nghĩa thực tế (|β_nữ - β_nam| > 0,10) sẽ được đánh dấu '
...
PB('In this study we tested whether the integrated risk-'
   ...
   'Cụ thể, mô hình các đường dẫn không bất biến chỉ ra rằng '
   '[CHỜ XÁC NHẬN: diễn giải thực chất].')

H2('4.2. Reconciliation with Jefferies & Ungar (2020) / Hòa '
   'giải khác biệt với Jefferies & Ungar (2020)')
PB('Phát hiện khác biệt giới trong SAD ở giai đoạn đầu vị '
   'thành niên của chúng tôi khác với kết quả không có khác '
   'biệt giới của Jefferies & Ungar (2020) trên thanh niên '
   '16-29 tuổi ở bảy quốc gia. Chúng tôi đưa ra sáu lý lẽ — '
   'bốn lý lẽ thực chất và hai lý lẽ phương pháp — để hòa '
...
PB('Argument 2 — Co-rumination in girls\' friendships. Rose '
   ...
   'Luận chứng 2 — Việc cùng đào sâu lo lắng trong tình bạn '
   'nữ. Rose (2002) giới thiệu khái niệm co-rumination '
   '(cùng đào sâu lo lắng) — xu hướng bạn thân đào sâu lặp '
...
PB('Argument 4 — School-based vs market-panel context. '
   ...
   'nhưng có thể lý giải một số khác biệt giới '
