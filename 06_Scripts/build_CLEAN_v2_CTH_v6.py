...
OUT = Path('c:/Users/HLC/OneDrive/read_books/Lo-au/01_Bao-cao/CLEAN_v2_CTH_v6_chuong_4_bo_sung.docx')
...
# Kết phần 4.1 — Năm phát hiện chính
H('Năm phát hiện chính từ đối chiếu', level=3)
para(
    'Tổng hợp đối chiếu kết quả nghiên cứu với cơ sở dữ liệu liên bài cho năm phát '
    'hiện chính. Thứ nhất, áp lực học tập và kỳ vọng tương lai là yếu tố nguy cơ '
    'NỔI BẬT NHẤT ở học sinh trung học cơ sở Việt Nam — sớm hơn giả định thông '
    'thường về áp lực thi cử. Thứ hai, lo âu lan tỏa và lo âu xã hội TĂNG theo '
    'khối lớp trong khi lo âu chia ly GIẢM — phù hợp developmental psychopathology. '
    'Thứ ba, nữ giới có điểm cao hơn nam ở ba trong bốn chỉ số — phù hợp y văn '
    'quốc tế với chênh lệch ~1,5–2 lần. Thứ tư, tự trọng là yếu tố bảo vệ MẠNH '
    'NHẤT, có cường độ ngang bằng với áp lực học tập — gợi ý chiến lược can thiệp '
    'song trục. Thứ năm, mô hình SEM tổng hợp giải thích 59,8% phương sai — vượt '
    'ngưỡng effect size lớn của Cohen (1988).'
)
...
# 4.4 — TLTK
# ============================================================
H('4.4. Tài liệu tham khảo bổ sung', level=2)
