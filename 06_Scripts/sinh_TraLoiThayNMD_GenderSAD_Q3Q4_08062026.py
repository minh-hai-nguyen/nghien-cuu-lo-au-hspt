...
P('Câu hỏi của thầy thực sự rất sắc bén. Em đề xuất 6 luận chứng — bốn '
  'luận chứng về cơ chế phát triển + văn hóa, hai luận chứng về '
  'phương pháp luận — để giải thích sự không nhất quán này.')
...
H3('Luận chứng 4 — Bối cảnh học đường vs population-based panel')
...
H3('Luận chứng 5 — Khác biệt phương pháp luận: cỡ mẫu + công cụ + sai lệch '
   'mẫu')
...
B('Mẫu Jefferies cho Việt Nam có M = 22,68 — thấp thứ 2 trong 7 '
  'quốc gia (sau Indonesia M = 18,94). Mẫu Việt Nam của Jefferies có '
  'thể đặc thù low-anxiety subgroup do tự chọn lọc participants, làm '
  'mất khả năng phát hiện gender difference.', 1)

H3('Luận chứng 6 — Hiệu ứng tuổi và quá độ phát triển')
